...
import { Sparkles, MapPin, ExternalLink, Heart, Send } from 'lucide-react';
      ...
      <div className="w-full px-4 sm:px-8 lg:px-16 xl:px-20 pt-12 sm:pt-16 pb-12 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 pb-16 border-b border-slate-800/80">
          ...
          <div className="lg:col-span-2 space-y-3">
            ...
            <ul className="space-y-2 text-sm text-slate-300">
              <li><Link to="/team" className="hover:text-white transition-colors">People & Team</Link></li>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-400">
          ...
          <p className="text-slate-400 font-mono text-center sm:text-right">
            {pageSubtitle}
          </p>
        </div>
